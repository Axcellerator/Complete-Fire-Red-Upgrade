...
extern const u8	gText_Experience[];
...
extern const u8	gText_25[];
extern const u8	gText_35[];
extern const u8	gText_45[];
extern const u8	gText_55[];
extern const u8	gText_65[];
extern const u8	gText_75[];
extern const u8	gText_85[];
extern const u8	gText_High[];
extern const u8	gText_Medium[];
extern const u8	gText_Low[];
extern const u8 NAME_SNORE[];
extern const u8 NAME_HEAL_BELL[];
extern const u8 NAME_ELECTROWEB[];
extern const u8 NAME_LOW_KICK[];
extern const u8 NAME_UPROAR[];
extern const u8 NAME_BIND[];
extern const u8 NAME_HELPING_HAND[];
extern const u8 NAME_BLOCK[];
extern const u8 NAME_WORRY_SEED[];
extern const u8 NAME_COVET[];
extern const u8 NAME_BUG_BITE[];
extern const u8 NAME_SNATCH[];
extern const u8 NAME_SPITE[];
extern const u8 NAME_AFTER_YOU[];
extern const u8 NAME_SYNTHESIS[];
extern const u8 NAME_SIGNAL_BEAM[];
extern const u8 NAME_GRAVITY[];
extern const u8 NAME_IRON_DEFENSE[];
extern const u8 NAME_TELEKINESIS[];
extern const u8 NAME_MAGNET_RISE[];
extern const u8 NAME_BOUNCE[];
extern const u8 NAME_ROLE_PLAY[];
extern const u8 NAME_ENDEAVOR[];
extern const u8 NAME_ICY_WIND[];
extern const u8 NAME_LASER_FOCUS[];
extern const u8 NAME_TRICK[];
extern const u8 NAME_DRILL_RUN[];
extern const u8 NAME_MAGIC_COAT[];
extern const u8 NAME_MAGIC_ROOM[];
extern const u8 NAME_WONDER_ROOM[];
extern const u8 NAME_GASTRO_ACID[];
extern const u8 NAME_FOUL_PLAY[];
extern const u8 NAME_SUPER_FANG[];
extern const u8 NAME_KNOCK_OFF[];
extern const u8 NAME_PSYCH_UP[];
extern const u8 NAME_VACUUM_WAVE[];
extern const u8 NAME_LAST_RESORT[];
extern const u8 NAME_CONFIDE[];
extern const u8 NAME_FOCUS_ENERGY[];
extern const u8 NAME_COSMIC_POWER[];
extern const u8 NAME_BATON_PASS[];
extern const u8 NAME_ENCORE[];
extern const u8 NAME_SCREECH[];
extern const u8 NAME_FAKE_TEARS[];
extern const u8 NAME_SCARY_FACE[];
extern const u8 NAME_VENOM_DRENCH[];
extern const u8 NAME_SPIKES[];
extern const u8 NAME_TOXIC_SPIKES[];
extern const u8 NAME_GRAS_TERRAIN[];
extern const u8 NAME_MIST_TERRAIN[];
extern const u8 NAME_ELEC_TERRAIN[];
extern const u8 NAME_PSYC_TERRAIN[];
extern const u8 NAME_WHIRLPOOL[];
extern const u8 NAME_FIRE_SPIN[];
extern const u8 NAME_SAND_TOMB[];
extern const u8 NAME_PIN_MISSILE[];
extern const u8 NAME_ICICLE_SPEAR[];
extern const u8 NAME_TAIL_SLAP[];
extern const u8 NAME_ROCK_BLAST[];
extern const u8 NAME_THUNDER_FANG[];
extern const u8 NAME_ICE_FANG[];
extern const u8 NAME_FIRE_FANG[];
extern const u8 NAME_HEAT_CRASH[];
extern const u8 NAME_HEAVY_SLAM[];
extern const u8 NAME_REVERSAL[];
extern const u8 NAME_ELECTRO_BALL[];
extern const u8 NAME_STORED_POWER[];
extern const u8 NAME_BREAKING_SWIPE[];
extern const u8 NAME_RAZOR_SHELL[];
extern const u8 NAME_HEX[];
extern const u8 NAME_WEATHER_BALL[];
extern const u8 NAME_FIRE_PUNCH[];
extern const u8 NAME_ICE_PUNCH[];
extern const u8 NAME_THUNDERPUNCH[];
extern const u8 NAME_IRON_HEAD[];
extern const u8 NAME_AQUA_TAIL[];
extern const u8 NAME_PAIN_SPLIT[];
extern const u8 NAME_TAILWIND[];
extern const u8 NAME_ZEN_HEADBUTT[];
extern const u8 NAME_SEED_BOMB[];
extern const u8 NAME_LIQUIDATION[];
extern const u8 NAME_OUTRAGE[];
extern const u8 NAME_SKY_ATTACK[];
extern const u8 NAME_THROAT_CHOP[];
extern const u8 NAME_BAD_TANTRUM[];
extern const u8 NAME_EARTH_POWER[];
extern const u8 NAME_GUNK_SHOT[];
extern const u8 NAME_DUAL_CHOP[];
extern const u8 NAME_HEAT_WAVE[];
extern const u8 NAME_HYPER_VOICE[];
extern const u8 NAME_SUPERPOWER[];
extern const u8 NAME_AIR_SLASH[];
extern const u8 NAME_AURA_SPHERE[];
extern const u8 NAME_BLAZE_KICK[];
extern const u8 NAME_BUG_BUZZ[];
extern const u8 NAME_CROSS_POISON[];
extern const u8 NAME_CRUNCH[];
extern const u8 NAME_DARK_LARIAT[];
extern const u8 NAME_HIGH_HORSEPOWER[];
extern const u8 NAME_LEAF_BLADE[];
extern const u8 NAME_MUDDY_WATER[];
extern const u8 NAME_MYSTIC_FIRE[];
extern const u8 NAME_PHANTOM_FORCE[];
extern const u8 NAME_PLAY_ROUGH[];
extern const u8 NAME_DRAGON_DANCE[];
extern const u8 NAME_POWER_GEM[];
extern const u8 NAME_PSYCHO_CUT[];
extern const u8 NAME_AGILITY[];
extern const u8 NAME_NASTY_PLOT[];
extern const u8 NAME_BODY_SLAM[];
extern const u8 NAME_BODY_PRESS[];
extern const u8 NAME_POLLEN_PUFF[];
extern const u8 NAME_PSYCHIC_FANG[];
extern const u8 NAME_BRAVE_BIRD[];
extern const u8 NAME_CLOSE_COMBAT[];
extern const u8 NAME_FLARE_BLITZ[];
extern const u8 NAME_HURRICANE[];
extern const u8 NAME_HYDRO_PUMP[];
extern const u8 NAME_LEAF_STORM[];
extern const u8 NAME_MEGAHORN[];
extern const u8 NAME_POWER_WHIP[];
extern const u8 NAME_SOLAR_BLADE[];
extern const u8 NAME_EXPANDING_FORCE[];
extern const u8 NAME_STEEL_ROLLER[];
extern const u8 NAME_SCALE_SHOT[];
extern const u8 NAME_METEOR_BEAM[];
extern const u8 NAME_MISTY_EXPLOSION[];
extern const u8 NAME_GRASSY_GLIDE[];
extern const u8 NAME_RISING_VOLTAGE[];
extern const u8 NAME_TERRAIN_PULSE[];
extern const u8 NAME_SKITTER_SMACK[];
extern const u8 NAME_BURNING_JEALOUSY[];
extern const u8 NAME_LASH_OUT[];
extern const u8 NAME_POLTERGEIST[];
extern const u8 NAME_CORROSIVE_GAS[];
extern const u8 NAME_COACHING[];
extern const u8 NAME_FLIP_TURN[];
extern const u8 NAME_TRIPLE_AXEL[];
extern const u8 NAME_DUAL_WINGBEAT[];
extern const u8 NAME_SCORCHING_SANDS[];
extern const u8 NAME_SOFT_BOILED[];
extern const u8 NAME_MOONBLAST[];
extern const u8 sNoThanks[];

extern const u8 sPallet[];
extern const u8 sViridian[];
extern const u8 sPewter[];
extern const u8 sRoute4[];
extern const u8 sCerulean[];
extern const u8 sVermillion[];
extern const u8 sRoute10[];
extern const u8 sLavender[];
extern const u8 sCeladon[];
extern const u8 sFuchsia[];
extern const u8 sSaffron[];
extern const u8 sCinnabar[];
extern const u8 sIndigoPlateau[];
extern const u8 sOneIsland[];
extern const u8 sTwoIsland[];
extern const u8 sThreeIsland[];
extern const u8 sFourIsland[];
extern const u8 sFiveIsland[];
extern const u8 sSixIsland[];
extern const u8 sSevenIsland[];
...
static const u8* sMultichoiceSet12[] = {
	...
	NAME_POWER_WHIP,
	NAME_SOLAR_BLADE,
	NAME_EXPANDING_FORCE,
	NAME_STEEL_ROLLER,
	NAME_SCALE_SHOT,
	NAME_METEOR_BEAM,
	NAME_MISTY_EXPLOSION,
	NAME_GRASSY_GLIDE,
	NAME_RISING_VOLTAGE,
	NAME_TERRAIN_PULSE,
	NAME_SKITTER_SMACK,
	NAME_BURNING_JEALOUSY,
	NAME_LASH_OUT,
	NAME_POLTERGEIST,
	NAME_CORROSIVE_GAS,
	NAME_COACHING,
	...
	NAME_TRIPLE_AXEL,
	NAME_DUAL_WINGBEAT,
	NAME_SCORCHING_SANDS,
	NAME_SOFT_BOILED,
	NAME_MOONBLAST,
	sNoThanks,
};

static const u8* sMultichoiceSet13[] =
{
	sPallet,
	sViridian,
	sPewter,
...
const struct ScrollingMulti gScrollingSets[] =
{
	...
	{sMultichoiceSet13, ARRAY_COUNT(sMultichoiceSet13)},
};
