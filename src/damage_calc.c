...
//Attacker Ability Checks
	switch(data->atkAbility) {
		...
		//1.5x Boost
			if (data->moveType == TYPE_GRASS && data->atkHP <= data->atkMaxHP / 2)
			{
				attack = (attack * 15) / 10;
				spAttack = (spAttack * 15) / 10;
			}
		...
		case ABILITY_BLAZE:
		//1.5x Boost
			if (data->moveType == TYPE_FIRE && data->atkHP <= data->atkMaxHP / 2)
			{
				attack = (attack * 15) / 10;
				spAttack = (spAttack * 15) / 10;
			}
		...
		//1.5x Boost
			if (data->moveType == TYPE_WATER && data->atkHP <= data->atkMaxHP / 2)
			{
				attack = (attack * 15) / 10;
				spAttack = (spAttack * 15) / 10;
			}
		...
		case ABILITY_SWARM:
		//1.5x Boost
			if (data->moveType == TYPE_BUG && data->atkHP <= data->atkMaxHP / 2)
			{
				attack = (attack * 15) / 10;
				spAttack = (spAttack * 15) / 10;
			}
...
//Attacker Item Checks
	switch (data->atkItemEffect) {
		...
		//1.3 Boost
			else if (SpeciesToNationalPokedexNum(data->atkSpecies) == NATIONAL_DEX_RAICHU)
			{
				attack *= (attack * 13) / 10;
