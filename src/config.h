...
#define FLAG_LEVEL_CAP 0x1034 //Flag checking for level caps
...
#define SAFARI_ZONE_MAX_STEPS 1200	//Number of safari zone steps the player has
...
#define EXISTING_OW_TABLE_ADDRESS 0x871FBA4 //Uncomment if you don't want new overworld NPC tables to be generated. DON'T TOUCH IF YOU DON'T KNOW EXACTLY WHAT THIS IS FOR!
